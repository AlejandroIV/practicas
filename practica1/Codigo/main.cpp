...
int main()
{
    ...
    ifstream archivoRead;
    archivoRead.open("ejemplo.txt", ios::in);  // Abre el archivo en modo lectura
    ...
    int contAux = 0;  // Auxiliar para el bucle "for"
    bool flagAux = false;
    ...
    while(!archivoRead.eof())  {
        // Lee las lineas del documento, los almacena en "textoStr", lo convierte a arreglo de caracteres y lo almacena en "textoArray"
    ...
    archivoRead.close();  // Cierra el archivo
